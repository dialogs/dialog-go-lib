// Code generated by "esc -o static.go -pkg test -no-compress assets"; DO NOT EDIT.
...
var _escDirs = map[string][]os.FileInfo{
	...
	"assets": {
		_escData["/assets/1_example.down.sql"],
		_escData["/assets/1_example.up.sql"],
	},
}
